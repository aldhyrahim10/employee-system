    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="{{ route('employee') }}"><i class="feather icon-users"></i><span class="menu-title"
                        data-i18n="Email">Karyawan</span></a>
            </li>
            <li class=" nav-item"><a href="{{ route('offwork') }}"><i class="feather icon-folder"></i><span
                        class="menu-title" data-i18n="Chat">Cuti Karyawan</span></a>
            </li>
            <li class=" nav-item"><a href="{{ route('user') }}"><i class="feather icon-users"></i><span
                        class="menu-title" data-i18n="Todo">User</span></a>
            </li>

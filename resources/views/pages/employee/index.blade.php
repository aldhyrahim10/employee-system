...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Karyawan</h2>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Data-data Karyawan</h4>
                </div>
                            ...
                            <table class="table zero-configuration">
                                ...
                                <tbody>
                                    ...
                                    <tr class="item-content">
                                        <td>
                                            {{ $loop->iteration }}
                                            <input type="hidden" class="hdnEmployeeID" value="{{$item->id}}">
                                        </td>
                                        <td>{{ $item->first_name }} {{$item->last_name}}</td>
                                        {{-- <td>aldimrahim09@gmail.com</td>
                                        <td>082113825774</td>
                                        <td>Laki-laki</td>
                                        <td>Jl. Pulo Harapan Indah No. 132</td> --}}
                                        <td class="text-center">
                                            <div class="btn btn-primary btn-detail" data-toggle="modal" data-target="#modalDetail">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="address" id="address" class="form-control" placeholder="Masukkan Alamat"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="formUpdateEmployee">
                <div class="modal-body">
                    <input type="hidden" id="hdnEmployeeID" value="">
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="">Nama Depan</label>
...
<div class="modal fade text-left" id="modalDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <input type="hidden" class="hdnEmployeeID" value="">
            <div class="modal-header">
...
<script>
    $(document).ready(function () {
        ...
        $(".btn-update").click(function(){
            ...
            var id = item.find(".hdnEmployeeID").val();

            $.ajax({
                url: "{{ route('get-one-employee') }}",
                type: "GET",
                data: {
                    'query': id
                },
                success: function (data) {
                    var formEditContent = $("#formUpdateEmployee");
                    formEditContent.find("#hdnEmployeeID").val(data.id);
                    ...
                    formEditContent.find("#mobile_phone").val(data.mobile_phone);
                    formEditContent.find("#gender").val(data.gender);
                    formEditContent.find("#address").val(data.address);
                }
            });
        });
        ...
        $("#formUpdateEmployee").submit(function(e){
            ...
            var id = $(this).find("#hdnEmployeeID").val();

            $.ajax({
                url: "{{ route('update-employee', ':id') }}".replace(':id', id),
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(".btn-delete").click(function(e){
            ...
            modalContent.find(".hdnEmployeeID").val(id);
        });

        $(".btn-delete-execute").click(function(e){
            var modalContent = $("#modalDelete");
            var id = modalContent.find(".hdnEmployeeID").val();
            var csrfToken = $('meta[name="csrf-token"]').attr('content');

            $.ajax({
                url: "{{ route('delete-employee', ':id') }}".replace(':id', id),
                type: "POST",
                data: {
                    '_token': csrfToken,
                    '_method': 'DELETE',
